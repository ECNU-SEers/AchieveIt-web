        ...
        >
            <el-table-column slot="prefix" type="expand">
                <template slot-scope="props">
                    <RolePermissions :is-project-permissions="true"
                                     readonly :permissions="props.row.permissions"/>
                </template>
            </el-table-column>
...
<script>
  ...
  import AddRoleDialog from '@/views/permission/project-role/AddRoleDialog';
  import EditRoleDialog from '@/views/permission/project-role/EditRoleDialog';
  ...
  import {getProjectRole} from '@/api/permisssion';
  ...
  export default {
    ...
    data() {
      return {
        ...
        tableHeader: Object.freeze(roleListTableHeader.filter(item => item.prop !== 'creator')),
    ...
    methods: {
      ...
      getRoleListFromServe() {
        this.applyLoading(getProjectRole(this.currentPage, this.pageSize)).then(res => {
