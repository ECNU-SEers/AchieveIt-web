    ...
    <el-dialog title="新建项目" :visible.sync="addFormVisible">
      ...
      >
        <el-form-item label="项目ID" required>
          <el-select v-model="addForm.projectId" placeholder="请选择ID"></el-select>
        </el-form-item>
        <el-form-item label="项目名称" style="width:500px" required>
          <el-input v-model="addForm.projectName" placeholder="请填写项目名称"></el-input>
        </el-form-item>
        <el-form-item label="客户" required>
          <el-select v-model="addForm.clientId" placeholder="请选择客户"></el-select>
        </el-form-item>
        ...
        <el-form-item label="项目经理" style="width: 500px" required>
          <el-input v-model="addForm.projectManager" disabled width="200px"></el-input>
        </el-form-item>
        <el-form-item label="项目主管" required>
          <el-select v-model="addForm.projectMentor" placeholder="请选择项目主管"></el-select>
        </el-form-item>
        <el-form-item label="采用技术" required>
          <el-select v-model="addForm.tech" placeholder="请选择采用技术"></el-select>
        </el-form-item>
        <el-form-item label="业务领域">
          <el-select v-model="addForm.area" placeholder="请选择业务领域"></el-select>
        </el-form-item>
        <el-form-item label="主要功能">
          <el-cascader v-model="addForm.function" placeholder="请选择主要功能"></el-cascader>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="编辑项目" :visible.sync="editFormVisible">
      <el-form ref="editForm" :model="editForm" label-width="80px" class="demo-ruleForm">
        <el-form-item label="项目ID">
          <el-select v-model="editForm.projectId" placeholder="请选择ID" disabled></el-select>
        </el-form-item>
        <el-form-item label="项目名称" style="width:500px">
          <el-input v-model="editForm.projectName" placeholder="请填写项目名称"></el-input>
        </el-form-item>
        <el-form-item label="客户">
          <el-select v-model="editForm.clientId" placeholder="请选择客户"></el-select>
        </el-form-item>
        ...
        <el-form-item label="项目经理" style="width: 500px">
          <el-input v-model="editForm.projectManager" disabled width="200px"></el-input>
        </el-form-item>
        <el-form-item label="项目主管">
          <el-select v-model="editForm.projectMentor" placeholder="请选择项目主管"></el-select>
        </el-form-item>
        <el-form-item label="采用技术">
          <el-select v-model="editForm.tech" placeholder="请选择采用技术"></el-select>
        </el-form-item>
        <el-form-item label="业务领域">
          <el-select v-model="editForm.area" placeholder="请选择业务领域"></el-select>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
